...
public class TPbala : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        posJugador = GameObject.Find("jugador").GetComponent<Transform>();
    ...
    private void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        else if (collider.gameObject.CompareTag("bala")) {
            posJugador.position = GetComponent<Transform>().position;
            Kill();
        }
